 ...
 function loadJSON(callback) {
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		loadJSON(function(response) {
			...
			' um ' + data.Zeit + 
			'</p></strong> <p><a href="http://onlineclass.netz-weise.de/b/hol-nc4-72g" target="_blank">Online Treffen starten... Raumzugangscode: 601730</a></p>'; 
			// + data.Ort + '.</strong></p>' + 
			...
			'<p id="pscode"><code>iwr https://www.psugh.de/data.json | ConvertFrom-Json</code></p>' +
